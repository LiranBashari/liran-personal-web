  ...
  return (
    <div>
      ...
      <Container>
            ...
            <Card>
              ...
              <Card.Body>
                ...
                <Card.Text style={{ fontSize: '1rem'}}>
                  ...
                  <span style={{ fontSize: '1rem', fontWeight: 'bold' }}>Technologies used:</span><br/>
                  • <span style={{ fontSize: '1rem', fontWeight: 'bold' }}>Socket.io</span> for real-time communication.<br/>
                  • <span style={{ fontSize: '1rem', fontWeight: 'bold' }}>MongoDB</span> for storing chat messages and user information.<br/>
                  • <span style={{ fontSize: '1rem', fontWeight: 'bold' }}>React</span>React for building the user interface.<br/>
                  • <span style={{ fontSize: '1rem', fontWeight: 'bold' }}>Node.js</span> for the backend server. <br/>
                </Card.Text>
              </Card.Body>
            </Card>
          </Carousel.Item>
            ...
            <Card>
              ...
              <Card.Body>
                ...
                <Card.Text style={{ fontSize: '1rem' , overflowWrap: 'break-word'}}>
                  ...
                  development, Mission Firing mechanism and scheduling logic to manage drones and their missions effectively. <br/>
        ...
        <div style={{ paddingTop: '20px', fontSize: '1.2rem', color: 'white' }}>
