  ...
  return (
    <div>
      ...
      <div className="container">
        <h1 className='text-white pt-5 display-2'>
        ...
        <div className="row mt-5">
          ...
          <div className="col-md-6 pt-5">
            <a href="https://github.com/LiranBashari" className="text-white display-6" style={{ display: 'inline-block', whiteSpace: 'nowrap' }}>https://github.com/LiranBashari</a>
          </div>
        </div>
        <div className="row mt-5">
          <div className="col-md-6 pt-5 pr-md-4">
